...
<div class="container-fluid">
	<div class="row">
       ...
       <form  accept-charset="UTF-8"  action="{{ route('admin.updatepage') }}"  method="post" >
          ...
          <input type="hidden" name="pageid" value="{{$page->pageid}}">
					...
					<div class="col-sm-9">
						<div class="form-group">	
							...
							<input type="text" name="title" value="{{$page->title }}" id="page_title" class="form-control" placeholder="Enter title here">				
						</div>						
            <div class="form-group">  
              <input type="text" name="slug" value="{{ $page->slug }}" id="slug" class="form-control" placeholder="Enter slug here">        
            </div>

						<div class="form-group">		
							<textarea class="form-control" name="description" value="" rows="15">{!! $page->description !!}</textarea>
